...
// 生图强关键词（图片/插画/壁纸/海报/头像）或英文 image 词组
const IMAGE_KEYWORD_RE =
  /(?:画|生成|做|来|create|make|draw|paint|generate).{0,40}?(图片|插画|壁纸|海报|头像)|\b(?:draw|paint|sketch|generate|create)\b.{0,40}?\b(?:image|picture|photo|art|wallpaper|illustration)\b/i;
