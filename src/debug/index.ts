...
export {registerNavSlot, registerChatSender, executeAction, drcActions} from './actionRegistry';
...
export type {DrcCommand, DrcResult, DrcEvent, DrcStateSnapshot, StateCompass} from './drcTypes';
